...
public class DismissTimer extends DeskClockAction {
    ...
    private static final String TAG = "Oslo/DismissTimer";

    public DismissTimer(Context context, OsloServiceManager osloServiceManager) {
    ...
    public OsloGestureConfig getGestureConfig() {
        return new OsloGestureConfig(OsloStrings.OsloBuiltInActionIds.CONFIG_ID_DISMISS_TIMER, CONFIG_DETECTION_RADIUS, 1, 3);
    }
}
